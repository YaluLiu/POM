...
def genBackground_one(seg_model, img_path, score_thresh = 0.9, binary_thresh = 0.5, cuda=True):
    ...
    B = output["masks"][idx]
    #print("cam{},size of B:{}".format(str(cam_id),B.size()))
    image = None
    for img in B:
